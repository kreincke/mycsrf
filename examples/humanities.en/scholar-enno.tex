...
\subtitle{Annotations in Footnotes - but correctly: Release \input{inc.rel.tex}}
\author{Karsten Reincke\input{cfg/inc.license-fn.tex}}

\maketitle
%%-- end(titlepage)

\input{snippets/ENC0-BothAbstractInc.tex}

\footnotesize
\tableofcontents
\normalsize

\input{snippets/ENC1-BothStyleDemoInc.tex}
