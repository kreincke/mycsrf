...
\textit{PMX}-Syntax wird dann um den Preis einer komplizierten Texteingabe
erkauft\footnote{Weil \TeX\ 'zu' kompliziert war, wurde \LaTeX\ 'erfunden';
und weil \textit{PMX} mit Text 'zu' kompliziert war, entstand \textit{M-Tx}
...
Musix\TeX-Code, bei dem man, will man ihn erfolgteiche in eine
Musix\TeX-in-\LaTeX-Umgebung \verb|\begin{music} ... \end{music}| einbetten,
noch  einige Zeilen auskommentieren und einige Werte ändern muss:
