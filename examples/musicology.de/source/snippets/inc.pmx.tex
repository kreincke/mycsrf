...
Einen Ausweg aus diesem Dilemma -- so das Tutorial -- biete \emph{PMX}, das als
...
Graphik zuerst \emph{PMX} zu lernen, wo es doch so viele gute Notenprogramme
gibt, die ihre Daten auch als Postscript- oder PDF-Datei
exportieren?\footnote{Zu Erinnerung: \emph{ABC} geht implizit genauso vor.
Insofern träfe dieses Argument eben auch \emph{ABC}. Allerdings punktet
\emph{ABC} durch seine vielen Konverter und Tools und durch seiner lange
...
\hu{`f}\bigsh{'d}\zh d\hu{`f}\zh{'e}\hu b\zh e\hu b\en%
% Bar count 2
\xbar
...
Oktavierung führte. Tatsächlich wird man -- falls man den MusiX\TeX-Code, den
\texttt{pmxab} aus der \emph{pmx}-Datei erzeugt, in seinen \LaTeX-Code einfügen
will -- ein wenig 'Tuning'-Zeit einplanen müssen. Geht man diesen Weg, kann man
nun allerdings auch die \LaTeX-basierten Elemente einer Harmonieanalyse darin
verwenden. Man hat also tatsächlich die gestalterische Freiheit auf
...
erledigt man auf \emph{PMX}-Level, die Feinheiten fügt man manuell ein:
...
\notes
  ...
  \zmidstaff{\HH.\Dohne.3..7.9.}\zh G\hl C |%
