...
\hline
\multirow{2}{*}{*} & \multirow{2}{*}{nach:} & \multirow{2}{*}{ABC} & 
          \multirow{2}{*}{MusiX\TeX} & 
          \multirow{2}{*}{PMX} & 
          \multirow{2}{*}{LilyPond} \\
 & &  &  &  &   \\
\hline
...
\begin{itemize}
  ...
  $\varnothing$] \item Die Konverter von \acc{LilyPond} nach \acc{ABC} resp. von
  \acc{MusicXML} nach \acc{ABC} scheinen erst einmal nachrangig zu sein: Denn
  ...
  \textit{LilyPond}- resp. \textit{MusicXML}-Datei ins \acc{ABC}-Format und von
  dort aus mittels des Konverters \acc{abc2mtex} ins Musix\TeX-Format transferieren.
