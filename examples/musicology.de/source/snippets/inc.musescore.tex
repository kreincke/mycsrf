...
Releases steht je ein Online-Handbuch zur Verfügung, für \acc{MuseScore2}
...
\acc{MuseScore} selbst zum Download bereit, sondern das \acc{Open Source Lab}
der \acc{Oregon State University}.\footnote{ $\rightarrow$
...
\acc{MuseScore}-Handbuches 'nur' über eine 'Fremd-URL' erreichbar sind. Neben
diesen Handbüchern gibt es noch Video-Tutorials\footcite[vgl.][\nopage
wp]{MuseScore2019e} und textuelle 'HowTos' zu speziellen
Themen.\footcite[vgl.][\nopage wp]{MuseScore2019f} Insgesamt ist \acc{MuseScore}
