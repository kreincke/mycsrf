...
\label{MuX2d}\acc{MuX2d} beschreibt sich als \enquote{WYSIWYM(ean) editor for MusiXTeX}, will
...
Open-Source-\acc{MusiX\TeX}-Frontend weckt in unserem Kontext natürlich
