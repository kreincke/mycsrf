...
\acc{\LaTeX\,+\,MusiX\TeX} und \acc{\LaTeX\,+\,LilyPond}:
...
Der \textbf{Vorteil} des \acc{\LaTeX\,+\,MusiX\TeX}-Ansatzes liegt in der bruchlosen
...
Der \textbf{Nachteil} \acc{\LaTeX\,+\,LilyPond}-Methode besteht dagegen darin,
...
gegenüber, die Methode \acc{\LaTeX\,+\,LilyPond\,+\,harmonyli.ly} zum Mittel der
Wahl machen:
...
\begin{itemize}
  ...
  \item Vielleicht sollte man auch erwähnen, dass mit \acc{Canorus} noch ein
