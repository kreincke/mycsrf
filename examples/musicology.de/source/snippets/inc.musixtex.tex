...
näher, als mit der Rekonstruktion anhand der \emph{ABC}-Methodik. Die 
...
Zudem zeigt dieses Beispiel gut, dass man in den MusiX\TeX-Code direkt
auch die Analysesymbole einbetten kann, die nicht von MusiX\TeX\ selbst
bereitgestellt werden, sondern z.B. von \emph{harmony}.
