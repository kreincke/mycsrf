...
hinzulädt. Sie soll im wesentlichen dieselbe Funktionalität für \acc{LilyPond}
bereitstellen, die man via \acc{Harmony} in \LaTeX\ und Musix\TeX\ verwenden
kann.\footnote{\ra\ S.\pageref{Harmony}} Aus Respekt vor der Vorlage soll diese
kleine Zusatzbibliothek \acc{Harmonyli} heißen, was als \acc{LilyPond}-Datei --
nicht ganz unabsichtlich -- zu dem Namen \texttt{harmonyli.ly} führt.
Hat man diese Bibliothek eingebunden, kann man die entsprechende Symbole der
Harmonieanalyse in seinen Notentext hinzufügen. Unsere aktuelle stabile Version
liefert folgendes -- sicher noch nicht ganz optimales -- Ergebnis:\footnote{Die
Einschränkungen werden aber nicht so bleiben! Z.Zt. benötigen wir noch \ldots
\begin{itemize}
...
\version "2.18.2"
\header { tagline = "" }
\include "lilypond/inc.harmonyli.ly"
\score {
  \new StaffGroup {
    \time 4/2
    <<
