...
\acc{\LaTeX\,+\,MusiX\TeX\,+\,harmony} und \acc{\LaTeX\,+\,LilyPond,+\,harmonyli}.

Für \acc{LilyPond,+\,harmonyli} steht uns \acc{Frescobaldi} als bester
semi-graphischer Editor zur Verfügung. Den Weg hatten wir bereits erfolgreich
getestet. \acc{\LaTeX\,+\,MusiX\TeX\,+\,harmony} konnten wir bisher nur mit
einem traditionellen Texteditor verknüpfen.

Wollten wir \acc{LilyPond} stattdessen 'mit' einem graphischen Editor benutzen,
müssten wir überprüfen, ob der MusicXML-Export von \acc{MuseScore} mittels des
Konverters \acc{musicxml2ly} oder der ABC-Export von EasyABC mittels des
Konvertes \acc{abc2ly} für \acc{Frescobaldi} importierbar wird.\footnote{Dass wir
...
\acc{abcmtex} zu \LaTeX-kompatiblen \acc{MusiX\TeX}-Code wird.
...
Wir könnten das eigentlich sogar noch schärfer eingrenzen: Wenn es uns gelänge,
\acc{MuseScore} erfolreich mit \acc{Frescobaldi} \& \acc{LilyPond} zu verküpfen,
bräuchten wir die Variante \acc{Easyabc} + \acc{Frescobaldi} \& \acc{LilyPond}
nicht mehr zu testen, weil ja \acc{MuseScore} das bessere Frontend ist. Trotzdem
