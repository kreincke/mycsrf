...
\acc{\LaTeX\,+\,MusiX\TeX\,+\,harmony} und \acc{\LaTeX\,+\,LilyPond,+\,harmonyli.ly}.
...
\acc{Frescobald} vorgestellt haben, nutzt er doch -- wie \acc{Elysium} auch --
direkt das Backend \acc{LilyPond}, um die Eingaben zu visualisieren.
