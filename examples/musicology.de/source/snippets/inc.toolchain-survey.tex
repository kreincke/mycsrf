...
\converter{\mxmlInColor}{\abcOutColor}{XML2ABC}{1.5}{6}{xml2abc}
...
Editor für \acc{MusiX\TeX} gibt. Deshalb haben wir ersatzweise den reinen
...
sich schon vorher ergeben, dass das \acc{\LaTeX-ABC-Backend} nur die Integration
...
Informationen ableiten. Die letzte beiden - die \acc{Qualität des Ergebnisses}
und die \acc{Nutzbarkeit des Weges} müssen wir noch empirisch ermitteln. Wir
wollen sie anschlißend nach einem festen Schema in einem einzigen Wert der
\acc{Prozessgüte} zusammenfassen:
