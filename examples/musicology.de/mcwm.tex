...
\emph{LilyPond} hat beschrieben, was man eigentlich nur tun muss, wenn man Noten
als eine Graphik einbinden will: 
\begin{quote} \begin{em}
  \enquote{Wenn Sie in ein Dokument Grafiken Ihres Musiksatzes einfügen möchten,
