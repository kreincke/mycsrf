% German fodina humanities final bibfile review file 
%
...
\input{fodinaHumanitiesJbibCfgDeInc}

% language specific hyphenation
\input{fodinaHumanitiesHyphenationInc}
...
%- start(footnote-confodinaHumanitiesBibRevResourcesDe.texfiguration)
...
\subject{Final BiBTeX-File}
\title{Review}
\subtitle{../bibfiles/fodinaHumanitiesExDe.bib}
\input{fodinaHumanitiesAuthorLicenseInc}

%\thanks{den Autoren von KOMA-Script und denen von Jurabib}
\maketitle
%%-- end(titlepage)

Inhalt des BiBTeX-Files {\bfseries ../bibfiles/fodinaHumanitiesExDe.bib}
