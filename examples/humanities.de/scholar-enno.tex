...
\subtitle{Über Anmerkungsapparate in Endnoten - aber richtig: Release \input{inc.rel.tex}}
...
\input{snippets/DEC1-EnNoFormFollowsFunctionInc.tex}
...
\input{snippets/DEC7-EnNoFunctionFormsThanksInc}
