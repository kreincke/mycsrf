...
(  'fileadmin/images/myCsrfTopSlide-01.png', 
   'fileadmin/images/myCsrfTopSlide-02.png', 
   'fileadmin/images/myCsrfTopSlide-03.png',
   'fileadmin/images/myCsrfTopSlide-04.png',
   'fileadmin/images/myCsrfTopSlide-05.png'
);
...
var def_pichei=32; //... and this to the height of your highest pic
var def_backgr="#f0f0f0"; //set this to the background color you want to use for the slide-area
//(for example the body-background-color) if your pics are of different size
var def_sdur=0.5; //time to show a pic between fades in seconds
var def_fdur=0; //duration of the complete fade in seconds
